...
//				shadowglow	3
	...
	InheritableProperties
	{
		...
		TabsBackgroundShort
	    {
	        ...
	        enabled					1
	        proportionalToParent    1
	        rui 					"ui/short_tabs_background.rpak"
	    }
        ...
        TabsBackgroundTallWithCapstone
        {
            zpos					2
            wide					f0
            tall					84
            ...
            enabled					1
            proportionalToParent    1
            rui 					"ui/tall_tabs_background_with_capstone.rpak"
        }

		//tabs_private_match_lobby & tabs_inspect_stats
		TabButtonCharacterCustomize //to be deleted with next tabs pass
		{
			classname				TabButtonClass
			wide					260
			tall					44
		...
		TabButtonWeaponCustomize //to be deleted with next tabs pass
		{
			classname				TabButtonClass
			wide					260
			tall					44
